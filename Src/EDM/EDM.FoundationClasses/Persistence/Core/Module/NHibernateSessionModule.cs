...
namespace EDM.FoundationClasses.Persistence.Core.Module
{
    /// <summary>
    ...
    public class NHibernateSessionModule : IHttpModule
    {
        ...
        {
            try     { NHibernateSessionManager.Instance.CommitTransaction(); }
            finally {  NHibernateSessionManager.Instance.CloseSession();     }
        }
