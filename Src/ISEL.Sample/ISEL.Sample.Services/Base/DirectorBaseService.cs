...
namespace ISEL.Sample.Services.Base
{
    ...
    {   
        ...
        public virtual long Create(double LimiteCartaoCredito, int Numero, DateTime DtAdmissao, string Nome, DateTime DtNascimento, string NIF)
        {
            Director record = new Director(){ Nome = Nome, DtNascimento = DtNascimento, NIF = NIF, Numero = Numero, DtAdmissao = DtAdmissao, LimiteCartaoCredito = LimiteCartaoCredito };            
        ...
        public virtual void Update(long recordId, double LimiteCartaoCredito, int Numero, DateTime DtAdmissao, string Nome, DateTime DtNascimento, string NIF)
        {             
        ...
        public virtual Director ReadByUnique()
        {
            return null;
        }
