...
namespace FutureView.ECom.Services
{
  public class UserRegisterService : Base.UserRegisterBaseImplementationService
  {
      ...
      {
          Customer customer = new IndividualCustomer() { AccountNonExpired = true, AccountNonLocked = true, BirthDate = BirthDate, CreateDate = DateTime.Now, CredentialsNonExpired = true, Enabled = true, FailedLoginCount = 0, FirstName = FirstName, Hint = Hint, HintAnswer = HintAnswer, LastFailedLogin = false, LastLoginDate = new DateTime(2000, 1, 1), LastName = LastName, Nif = Nif, Password = Password, Title = Title, UserName = UserName };
      ...
      {
          Customer customer = new BusinessCustomer() { AccountNonExpired = true, AccountNonLocked = true, BirthDate = BirthDate, CreateDate = DateTime.Now, CredentialsNonExpired = true, Enabled = true, FailedLoginCount = 0, Hint = Hint, HintAnswer = HintAnswer, LastFailedLogin = false, LastLoginDate = new DateTime(2000, 1, 1), Capital = Capital, CreditLimit = 7500, Name = Name, Nif = Nif, Password = Password, UserName = UserName };
