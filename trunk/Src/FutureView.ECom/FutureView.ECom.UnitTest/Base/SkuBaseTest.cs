...
namespace FutureView.ECom.UnitTest.Base
{
  ...
  public class SkuBaseTest
    ...
    {
      id = service.Create("Description", true, 1, 1, 1, 1, 1, 1, new DateTime(2010, 1, 1), new DateTime(2010, 1, 1), 1, 1, "SmallImagePath", "LargeImagePath", 1, "SkuCode");
    ...
    {      
      service.Update(id, "Description_2", false, 2, 2, 2, 2, 2, 2, new DateTime(2010, 2, 2), new DateTime(2010, 2, 2), 2, 2, "SmallImagePath_2", "LargeImagePath_2", 2, "SkuCode_2");
      ...
      Assert.AreEqual(target.DateToMarket, 2);
