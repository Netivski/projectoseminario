    ...
    internal class GeneratorSteps : AbstractStep
    {
        ...
        void SetSteps(GeneratorContext context)
        {
            steps = new List<AbstractStep>(){
                    ...
                    ,new Step( "BaseIDaoInterface"        , Path.Combine( context.Output.EntityDataInterfacesBasePath, "IDaoInterface.cs"                ), context.ThreeDFile.XPath.Root     , true  )                                                    
                    ...
                    ,new Step( "BaseNHibernateDaoFactory" , Path.Combine( context.Output.EntityDataBasePath          , "NHibernateDaoFactoryBase.cs"     ), context.ThreeDFile.XPath.Root     , true  )                                 
